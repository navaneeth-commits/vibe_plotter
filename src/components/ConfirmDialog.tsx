      ...
      >
        <div className="p-5 flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 id="confirm-dialog-title" className="text-base font-bold text-stone-900 font-['Space_Grotesk']">
              {title}
            </h3>
            <p id="confirm-dialog-description" className="mt-1.5 text-sm text-stone-600 leading-relaxed">
              {message}
            </p>
          </div>
